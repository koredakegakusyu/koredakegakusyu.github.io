...
window.CURRICULUM.push(
  {
    ...
    understand: [
      ...
      },
      {
        ...
        body:
          "<p>リージョン/AZよりもさらに<strong>利用者に近い場所</strong>に置かれた、世界中に数百ある配信拠点が<strong>エッジロケーション</strong>です。<strong>CloudFront（CDN）</strong>や<strong>Route 53（DNS）</strong>が使い、コンテンツを利用者の近くのエッジからキャッシュ配信することで<strong>体感速度を上げます</strong>。AZよりはるかに数が多いのが特徴です。</p>" +
          "<p>『AZ＝可用性のための独立データセンター』『エッジ＝速さのための配信拠点』と役割を分けて覚えます。</p>",
      },
    ],
    memorize: [
