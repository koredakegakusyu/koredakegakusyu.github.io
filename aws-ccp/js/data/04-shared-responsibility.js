...
window.CURRICULUM.push(
  {
    ...
    understand: [
      ...
      },
      {
        ...
        body:
          "<p>利用者の責任範囲は<strong>使うサービスのタイプで変わります</strong>。管理を任せられるサービスほど、利用者の責任は小さくなります。</p>" +
          "<ul>" +
          "<li><strong>EC2（IaaS）</strong>：OSの更新・パッチ適用・ミドルウェアの管理まで<strong>利用者の責任</strong>（自由度が高い分、守る範囲も広い）。</li>" +
          "<li><strong>RDSやLambda（マネージド型）</strong>：OSやハードの管理は<strong>AWSが担当</strong>。利用者は主に<strong>データとアクセス権</strong>に責任を持つ。</li>" +
          "</ul>" +
          "<p>ただし<strong>どんなサービスでも『データそのもの』と『誰にアクセスを許すか（IAM）』は常に利用者の責任</strong>である点は共通です。</p>",
      },
    ],
    memorize: [
